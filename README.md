...
### Привести описание того, как происходит сборка проекта проекта под другие платформы. Какие могут быть особенности?
 ...
 Чтобы посмотреть на то, как проект будет выглядеть вне редактора или для публикации проекта испольуется функция Build. Unity позволяет делать билды проектов как для ПК, например для Windows или IOS, так и для мобильный устройств или консолей. В результате билда могут в итоге могут получаться разные файлы. Например, при билдне под Windows мы получаем папку Data, содержащую все ресурсы и приложения, и исполняемый файл .exe, а при билде под IOS получим “app bundle”, содержащий все необходимые файлы для запуска приложения и его ресурсы.
