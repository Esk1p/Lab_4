...
3. Теперь анимируем ранее добавленный ранее объект (ToxicFrog), чтобы сцена выглядела интереснее. Для этого зайдем в аниматор и создадим новую анимацию FrogAnimation. В моей анимации объект меняет свое положение по Y. В итоге перечисленных действий получаем следующее: 
